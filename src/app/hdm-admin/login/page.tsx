    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="text-center mb-8">
          <HDMLogo size="large" className="justify-center mb-4" />
        </div>
            ...
            <div>
              <button
                ...
                style={{
                  ...
                  '--tw-ring-color': '#0e2c3d'
                } as React.CSSProperties}
                onMouseEnter={(e) => {
                  e.currentTarget.style.backgroundColor = '#5895a5'
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.backgroundColor = '#0e2c3d'
                }}
              >
