...
async function main() {
  ...
  // Create published version for ACME
    await prisma.partnerVersion.create({
      data: {
        ...
        branding: acmePartner.branding as any,
        emailCfg: acmePartner.emailCfg as any,
        formCfg: acmePartner.formCfg as any,
        pricingCfg: acmePartner.pricingCfg as any,
        features: acmePartner.features as any
      }
    })
  ...
  await prisma.partnerVersion.create({
    data: {
      ...
      isPublished: true,
      publishedAt: new Date(),
      branding: blueRocketPartner.branding as any,
      emailCfg: blueRocketPartner.emailCfg as any,
      formCfg: blueRocketPartner.formCfg as any,
      pricingCfg: blueRocketPartner.pricingCfg as any,
      features: blueRocketPartner.features as any
    }
  })
